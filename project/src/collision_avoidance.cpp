...
int main(int argc, char **argv)
{
    ...
    drone1_sub = nh.subscribe<project::Drone_pos>("/uav0/drone1_global_pos", 10, d1_pos_cb);
    drone2_sub = nh.subscribe<project::Drone_pos>("/uav1/drone2_global_pos", 10, d2_pos_cb);
    drone3_sub = nh.subscribe<project::Drone_pos>("/uav2/drone3_global_pos", 10, d3_pos_cb);
    ...
    while (ros::ok())
    {
    	...
    	// ROS_INFO("Changes: %.2f, %.2f, %.2f", d1_change, d2_change, d3_change);
